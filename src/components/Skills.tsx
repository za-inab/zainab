...
function SkillCard({ skill }: { skill: Skill }) {
  ...
  return (
    <div
      className="group relative w-20 h-20 md:w-24 md:h-24 bg-gray-900/60 border border-gray-800 rounded-xl flex items-center justify-center cursor-pointer transition-all duration-300 hover:border-green-400 hover:bg-gray-800/80 hover:scale-105 bg-gradient-to-b from-emerald-950 to-transparent"
