  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-lg text-white text-sm hover:border-green-400 transition-all duration-300 group"
      ...
      >
        ...
        <ChevronDown 
          size={16} 
          className={`transition-transform duration-200 group-hover:text-green-400 ${
